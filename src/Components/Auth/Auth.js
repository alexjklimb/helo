            ...
            <main id='auth'>
                <section className='login-form'>
                    ...
                    <div className='login-input'>
                        <span>Username:</span>
                        <input maxLength='11' onChange={(e) => this.handleInput(e.target.value, 'username')} value={this.state.username} />
                    </div>
                    <div className='login-input'>
                        <span>Password:</span>
                        <input maxLength='ll' onChange={(e) => this.handleInput(e.target.value, 'password')} value={this.state.password} type='password' />
                    </div>
